...
final class InitializedSymfonyExtensionEnvironment implements SymfonyExtensionEnvironment
{
    ...
    public function bindCallee(Callee $callee): callable
    {
        ...
        // The LateBoundContextMethodCallable class only exists in Behat 4.x; on Behat 3.x
        // this instanceof safely evaluates to false at runtime.
        /** @psalm-suppress UndefinedClass */
        if ($callable instanceof LateBoundContextMethodCallable) {
            /** @psalm-suppress UndefinedPropertyFetch, MixedMethodCall, UndefinedMethod */
